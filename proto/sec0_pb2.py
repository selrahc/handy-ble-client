...
S0SessionCmd = _reflection.GeneratedProtocolMessageType('S0SessionCmd', (_message.Message,), {
...
S0SessionResp = _reflection.GeneratedProtocolMessageType('S0SessionResp', (_message.Message,), {
...
Sec0Payload = _reflection.GeneratedProtocolMessageType('Sec0Payload', (_message.Message,), {
